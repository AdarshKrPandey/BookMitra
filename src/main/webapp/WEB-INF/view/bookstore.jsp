    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="cart">Cart (<span id="cartCount">${cartSize}</span>)</a></li>
            </ul>
        </div>
    </div>
</nav>
            ...
            <div class="col-md-3 book-card">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="add-to-cart/${book.bookId}" class="btn add-to-cart-btn">Add to Cart</a>
                    </div>
                </div>
            </div>
        </c:forEach>
