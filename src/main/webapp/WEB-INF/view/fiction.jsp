...
<div class="container mt-4">
    ...
    <div class="row">
        ...
        <div class="col-md-3 book-card">
            <div class="card">
                <img src="<c:url value="/resources/image/fiction.webp" />" class="card-img-top" alt="Book 1">
                <div class="card-body">
        ...
        <div class="col-md-3 book-card">
            <div class="card">
                <img src="<c:url value="/resources/image/fiction1.webp" />" class="card-img-top" alt="Book 2">
                <div class="card-body">
        ...
        <div class="col-md-3 book-card">
            <div class="card">
                <img src="<c:url value="/resources/image/fiction2.png" />" class="card-img-top" alt="Book 3">
                <div class="card-body">
        ...
        <div class="col-md-3 book-card">
            <div class="card">
                <img src="<c:url value="/resources/image/fiction3.jpg" />" class="card-img-top" alt="Book 4">
                <div class="card-body">
        ...
        <div class="col-md-3 book-card">
            <div class="card">
                <img src="<c:url value="/resources/image/fiction4.jpg" />" class="card-img-top" alt="Book 5">
                <div class="card-body">
        ...
        <div class="col-md-3 book-card">
            <div class="card">
                <img src="<c:url value="/resources/image/fiction5.jpg" />" class="card-img-top" alt="Book 6">
                <div class="card-body">
